...
/**
 * Dashboard-specific header that mirrors PageHeader spacing/typography so the
 * first viewport chrome matches Sites / Projects / Settings.
 */
  ...
  return (
    <div className="mb-6 flex shrink-0 flex-wrap items-center gap-x-4 gap-y-3 border-b border-line pb-4">
      <div className="flex min-w-0 items-center gap-3">
        <span className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-full border border-line bg-raised">
          <Image
      ...
      >
        <div className="group relative">
          ...
          <input
            ...
            className="h-10 w-full rounded-lg border border-line bg-base pl-10 pr-16 text-sm text-primary placeholder:text-faint outline-none transition-colors hover:border-line-strong focus:border-accent focus:ring-2 focus:ring-accent/25"
          />
